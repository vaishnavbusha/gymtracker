...
Map<int, String> userLevels = {0: 'user', 1: 'admin', 2: 'creator'};
...
final pagesList = [const ExplorePage(), const ScanPage(), const ProfilePage()];
final adminPagesList = [const ExplorePage(), const ProfilePage()];
