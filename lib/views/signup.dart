      ...
      child: Consumer(builder: (context, ref, child) {
        ...
        shape: RoundedRectangleBorder(
         // side: BorderSide(width: 1.0, style: BorderStyle.solid, color: Colors.cyan),
          ...
          child: Stack(
            children: [
              Container(height: 47.h,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.r),),),
              Positioned(left: 10.w,top: 0,bottom: 0,child: AnimatedSwitcher(duration: Duration(milliseconds: 250,), child: (register.selectedgender == 'Male') ?  Icon( Icons.male_outlined,color:Color(0xff7e7d7d).withOpacity(0.7),key: Key('1'),) : Icon(Icons.female_outlined,color:Color(0xff7e7d7d).withOpacity(0.7),key: Key('1'),) ,)),
              Positioned(
                top: 0,
                bottom: 0,
                right: 0,
              ...
              suffixIcon: (isObscure)
                  ? GestureDetector(
                      ...
                      child: (labeltext == "Password")
                          ...
                          :AnimatedSwitcher(  switchInCurve:
                                                Curves.fastEaseInToSlowEaseOut,
                                            switchOutCurve:
                                                Curves.fastEaseInToSlowEaseOut, duration: Duration(
                              milliseconds: 200,
                              
                            ),child: (signUpController_var.confirmpass_isobscure)
                              ? Icon(
                                  Icons.visibility_off,
                                     key: Key('1'),
                                  color: Color(0xffFED428).withOpacity(0.5),
